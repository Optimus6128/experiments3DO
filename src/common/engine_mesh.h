...
#define MESH_OPTION_RENDER_SOFT16	(1 << 2)
#define MESH_OPTION_RENDER_SEMISOFT	(1 << 3)
#define MESH_OPTION_RENDER_SOFT		(MESH_OPTION_RENDER_SOFT8 | MESH_OPTION_RENDER_SOFT16 | MESH_OPTION_RENDER_SEMISOFT)
